...
select count(*) from l1books where authors is null or upper(authors)='NULL' or authors=''--31413
...
select count(*) from l1books where categories is null or upper(categories)='NULL' or categories=''--41199
...
select count(*) from l2books where title is null or upper(title)='NULL' or title=''--0
select count(*) from l2books where author is null or upper(author)='NULL' or author=''--0
select count(*) from l2books where yearofpublication is null or upper(yearofpublication)='NULL' or yearofpublication='' or yearofpublication='0'--4619
select count(*) from l2books where publisher is null or upper(publisher)='NULL' or publisher=''--0
select count(*) from l2books where imageurlm is null or upper(imageurlm)='NULL' or imageurlm=''--0
--COMPLETITUD-L1REVIEWS-----------------------------
select * from l1reviews limit 1
select count(*) from l1reviews--3000000
select count(*) from l1reviews where id is null or upper(id)='NULL' or id=''--0
select count(*) from l1reviews where title is null or upper(title)='NULL' or title=''--215
select count(*) from l1reviews where user_id is null or upper(user_id)='NULL' or user_id=''--561787
select count(*) from l1reviews where score is null or upper(score)='NULL' or score=''--0
--COMPLETITUD-L2REVIEWS-----------------------------
select * from l2reviews limit 1
select count(*) from l2reviews--1149780
select count(*) from l2reviews where userid is null or upper(userid)='NULL' or userid=''--0
select count(*) from l2reviews where isbn is null or upper(isbn)='NULL' or isbn=''--0
select count(*) from l2reviews where rating is null or upper(rating)='NULL' or rating=''--0
--COMPLETITUD-L2USERS-------------------------------
select * from l2users limit 1
select count(*) from l2users where userid is null or upper(userid)='NULL' or userid=''--0
----------------------------------------------------
--UNICIDAD-L1BOOKS----------------------------------
...
select count(*) from (select title, count(*)-1 as cantDup from l2books group by title having count(*)>1)--19907
select count(*) from (select author, count(*)-1 as cantDup from l2books group by author having count(*)>1)--33633
select count(*) from (select publisher, count(*)-1 as cantDup from l2books group by publisher having count(*)>1)--7667
select count(*) from (select imageurlm, count(*)-1 as cantDup from l2books group by imageurlm having count(*)>1)--316
--UNICIDAD-L1REVIEWS--------------------------------
select count(*) from (select id, count(*)-1 as cantDup from l1reviews group by id having count(*)>1)--152425
select count(*) from (select user_id, count(*)-1 as cantDup from l1reviews group by user_id having count(*)>1)--315257
select count(*) from (select title, count(*)-1 as cantDup from l1reviews group by title having count(*)>1)--141178
--UNICIDAD-L2REVIEWS--------------------------------
select count(*) from (select userid, count(*)-1 as cantDup from l2reviews group by userid having count(*)>1)--46117
select count(*) from (select isbn, count(*)-1 as cantDup from l2reviews group by isbn having count(*)>1)--143511
--UNICIDAD-L2USERS----------------------------------
select count(*) from (select userid, count(*)-1 as cantDup from l2users group by userid having count(*)>1)--0
----------------------------------------------------
...
select count(*) from l2books where length(yearofpublication)<>4--4619
--CONSISTENCIA-L1REVIEWS----------------------------
select count(*) from l1reviews where length(id)<>10--0
select count(*) from l1reviews where length(score)<>3--0
--CONSISTENCIA-L2REVIEWS----------------------------
select count(*) from l2reviews where length(isbn)<>10--10417
select count(*) from l2reviews where length(rating)>2 and rating<>'10'--0
--CONSISTENCIA-L2USERS------------------------------
----------------------------------------------------
--INTEGRIDAD-L1-------------------------------------
select count(*) from l1reviews r where not exists (select 1 from l1books b where upper(r.title)=upper(b.title))--1432743
--INTEGRIDAD-L2-------------------------------------
select count(*) from l2users
select count(*) from l2reviews r where not exists (select 1 from l2books b where upper(r.isbn)=upper(b.isbn))--118605
select count(*) from l2reviews r where not exists (select 1 from l2users u where r.userid=u.userid)--0
select count(*) from l2users u where not exists (select 1 from l2reviews r where r.userid=u.userid)--173575
----------------------------------------------------
----------------------------------------------------
--COMPLETITUD-LNBOOKS-------------------------------
...
select count(*) from lnbooks where dateofbook is null or upper(dateofbook)='NULL' or dateofbook=''--333
select count(*) from lnbooks where source is null or upper(source)='NULL' or source=''--264809
select count(*) from lnbooks where genres is null or upper(genres)='NULL' or genres=''--268220
--UNICIDAD-LNBOOKS----------------------------------
...
select count(*) from (select dateofbook, count(*)-1 as cantDup from lnbooks group by dateofbook having count(*)>1)--190
...
select count(*) from lnbooks where length(dateofbook)<>4--4557
